...
<%	
	 ...
	 PreparedStatement p = d.prepareStatement("SELECT count(*) FROM `cyber`.`empadd` where location='library' and osystem='unusual'");
	 //PreparedStatement p = d.prepareStatement("SELECT * FROM `admission`.`adminaccepttbl`");
	...
	<%	
	 ...
	 PreparedStatement p2 = d2.prepareStatement("SELECT count(*) FROM `cyber`.`empadd` where location='library' and osystem='secure'");
	 //PreparedStatement p = d.prepareStatement("SELECT * FROM `admission`.`adminaccepttbl`");
	...
	<%	
	 ...
	 PreparedStatement p3 = d3.prepareStatement("SELECT count(*) FROM `cyber`.`empadd` where location='library' and osystem='possible'");
	 //PreparedStatement p = d.prepareStatement("SELECT * FROM `admission`.`adminaccepttbl`");
