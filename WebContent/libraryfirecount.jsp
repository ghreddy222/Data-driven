...
<%	
	 ...
	 PreparedStatement p = d.prepareStatement("SELECT count(location) FROM `cyber`.`empadd` where location='library' and firewal='unusual'");
	 //PreparedStatement p = d.prepareStatement("SELECT * FROM `admission`.`adminaccepttbl`");
	...
	<%	
	 ...
	 PreparedStatement p2 = d2.prepareStatement("SELECT count(location) FROM `cyber`.`empadd` where location='library' and firewal='secure'");
	 //PreparedStatement p = d.prepareStatement("SELECT * FROM `admission`.`adminaccepttbl`");
	...
	<%	
	 ...
	 PreparedStatement p3 = d3.prepareStatement("SELECT count(location) FROM `cyber`.`empadd` where location='library' and firewal='possible'");
	 //PreparedStatement p = d.prepareStatement("SELECT * FROM `admission`.`adminaccepttbl`");
