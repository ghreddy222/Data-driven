...
<%	
	 ...
	 PreparedStatement p = d.prepareStatement("SELECT count(*) FROM `cyber`.`empadd` where location='library' and harddisk='unusual'");
	 //PreparedStatement p = d.prepareStatement("SELECT * FROM `admission`.`adminaccepttbl`");
	...
	<%	
	 ...
	 PreparedStatement p2 = d2.prepareStatement("SELECT count(*) FROM `cyber`.`empadd` where location='library' and harddisk='secure'");
	 //PreparedStatement p = d.prepareStatement("SELECT * FROM `admission`.`adminaccepttbl`");
	...
	<%	
	 ...
	 PreparedStatement p3 = d3.prepareStatement("SELECT count(*) FROM `cyber`.`empadd` where location='library' and harddisk='possible'");
	 //PreparedStatement p = d.prepareStatement("SELECT * FROM `admission`.`adminaccepttbl`");
