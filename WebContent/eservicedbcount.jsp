...
<%	
	 ...
	 PreparedStatement p = d.prepareStatement("SELECT count(location) FROM `cyber`.`empadd` where location='eservicecentre' and dbsetup='unusual'");
	 //PreparedStatement p = d.prepareStatement("SELECT * FROM `admission`.`adminaccepttbl`");
	...
	<%	
	 ...
	 PreparedStatement p2 = d2.prepareStatement("SELECT count(location) FROM `cyber`.`empadd` where location='eservicecentre' and dbsetup='secure'");
	 //PreparedStatement p = d.prepareStatement("SELECT * FROM `admission`.`adminaccepttbl`");
	...
	<%	
	 ...
	 PreparedStatement p3 = d3.prepareStatement("SELECT count(location) FROM `cyber`.`empadd` where location='eservicecentre' and dbsetup='possible'");
	 //PreparedStatement p = d.prepareStatement("SELECT * FROM `admission`.`adminaccepttbl`");
